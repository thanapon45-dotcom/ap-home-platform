# ⚠️ ARCHIVED — Superseded 2026-08-08

**This file is stale and kept for historical reference only.** It describes
the platform as of roughly April 2026 (V3.2 monolithic n8n workflow, local
dev ports, "รับสร้างบ้าน" as the core business description). None of that
reflects current state:

- Business: Unit 1 (รับสร้างบ้าน) discontinued per ADR-010 — see `docs/BUSINESS_MODEL.md`
- n8n: the "V3.2 FULL PRO MASTER FLOW" workflow named below no longer exists — split into WF1 (Article + Publish) and WF2 (Image + Patch), see `CLAUDE.md`
- Hub: `x-hub-secret`/local ports below are Hub v2 conventions — production runs on Hub v1 (`x-hub-token`, Railway URLs) as of the Jul 1, 2026 revert

**Current platform README**: see `README.md` (rewritten 2026-08-08).
