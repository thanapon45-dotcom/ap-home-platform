...
- [ ] **ยังไม่ได้ทำ**: ยืนยันสถานะ Business Unit 3 (Fix & Flip/รีโนเวทเพื่อขาย) กับ Archi ว่ายังทำอยู่หรือไม่ — ไม่ได้ถูกพูดถึงตรงๆใน "ลูกค้าผมมีแค่ 2 กลุ่ม" แต่เกี่ยวข้องกับงานก่อสร้าง/รีโนเวทซึ่งอาจขัดกับ "ไม่ทำธุรกิจรับเหมาก่อสร้าง" — ดู `docs/BUSINESS_MODEL.md` Unit 1 note + ADR-010
