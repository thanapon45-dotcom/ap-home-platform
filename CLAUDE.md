...
Last updated: 2026-07-20 (session 27 — แก้บั๊กภาษาไทยเพี้ยนใน AI Content Studio: root cause คู่ (maxTokens 800 ต่ำไป + KeywordTab.generate() หลุดไปใช้ Haiku แทน Sonnet) แก้ทั้งคู่แล้ว deploy+verify ผ่าน production (ADR-012, ISSUE-016, Known Bugs #13) — ยืนยันสัดส่วนธุรกิจจริง 3 หน่วย (Fix & Flip 60% / ที่ปรึกษา 30% / โบรกเกอร์ 10%) หลัง clarify ว่า "Develop" = Unit 3 ไม่ใช่ Unit 1 ที่ discontinued (ADR-011) + เพิ่ม "Platform Structure — 2 Pillars" section ใน BUSINESS_MODEL.md ตามกรอบคิดของ Archi พร้อม note ว่า 7 Intelligence Modules เชื่อมโยงกันทั้งหมดไม่แยก pillar (ADR-013) — Archi ยืนยันไม่ต้องล็อก auth หน้า CRM/Land Analyzer ตอนนี้ (ผู้ใช้คนเดียว) และไม่รีบตัดสินใจ Hub v2 — เอกสารที่ sync วันนี้: decisions.md (+ADR-011/012/013), issues-log.md (+ISSUE-016), HANDOFF.md (+Session 27), glossary.md, BUSINESS_MODEL.md, CLAUDE.md (นี้), memory/Claude md/CLAUDE.md)
