...
| BC-3.7 | Land/Deal Evaluation | Land Analyzer |
...
- **BD-3.3 — Fix & Flip Execution** *(distinct from BD-3.1 — see AO-3.1)*: renovation deal pipeline, sourced independently of CRM.
