...
> อัปเดตล่าสุด: 2026-07-20 (session 26) — **Business Unit 1 (รับสร้างบ้าน) ยืนยันจาก Archi ว่า discontinued แล้ว** ธุรกิจจริงตอนนี้เหลือ 2 กลุ่มลูกค้าหลักคือ (1) ซื้อ/ฝากขายบ้าน (Unit 2) และ (2) ที่ปรึกษา/ตรวจสอบงานก่อสร้าง (Unit 4) — ดู note ใต้หัวข้อ Unit 1 ด้านล่าง + `docs/decisions.md` ADR-010
...
> Archi ยืนยันตรงๆ ว่า**ไม่ทำธุรกิจรับเหมาก่อสร้าง** — หน่วยธุรกิจนี้ไม่ใช่ของจริงอีกต่อไป เหลือไว้ในเอกสารเพื่อ historical record เท่านั้น ห้ามใช้เป็น reference สำหรับ content/prompt/persona ใดๆ อีก (แก้แล้วใน `components/AIContent.tsx` — ดู `docs/decisions.md` ADR-010) ธุรกิจจริงตอนนี้คือ **Unit 2 (โบรกเกอร์)** + **Unit 4 (ที่ปรึกษา/ตรวจสอบงานก่อสร้าง)** เท่านั้น — สถานะ Unit 3 (Fix & Flip) ยังไม่ได้ยืนยัน ต้องถาม Archi ก่อนอ้างอิงว่ายังทำอยู่หรือไม่
...
> ⚠️ **หมายเหตุ (2026-07-20)**: diagram ด้านล่างยังมี node "รับสร้างบ้าน" อยู่ตามของเดิม แต่หน่วยธุรกิจนั้น discontinued แล้ว (ดู Unit 1 ด้านบน) — ยังไม่ได้ redesign loop ใหม่ให้เหลือแค่ 2-3 unit จริง รอ Archi ยืนยันสถานะ Unit 3 (Fix & Flip) ก่อนแก้ diagram นี้ทั้งหมด
